...
/// url
@JsonKey(name: SignedUrlResponse.urlKey_) String get url;/// expiresInSeconds
@JsonKey(name: SignedUrlResponse.expiresInSecondsKey_) int get expiresInSeconds;
...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is SignedUrlResponse&&(identical(other.url, url) || other.url == url)&&(identical(other.expiresInSeconds, expiresInSeconds) || other.expiresInSeconds == expiresInSeconds));
}
...
@override
String toString() {
  return 'SignedUrlResponse(url: $url, expiresInSeconds: $expiresInSeconds)';
}
...
@useResult
$Res call({
@JsonKey(name: SignedUrlResponse.urlKey_) String url,@JsonKey(name: SignedUrlResponse.expiresInSecondsKey_) int expiresInSeconds
});
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function(@JsonKey(name: SignedUrlResponse.urlKey_)  String url, @JsonKey(name: SignedUrlResponse.expiresInSecondsKey_)  int expiresInSeconds)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _SignedUrlResponse() when $default != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function(@JsonKey(name: SignedUrlResponse.urlKey_)  String url, @JsonKey(name: SignedUrlResponse.expiresInSecondsKey_)  int expiresInSeconds)  $default,) {final _that = this;
switch (_that) {
case _SignedUrlResponse():
return $default(_that.url,_that.expiresInSeconds);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function(@JsonKey(name: SignedUrlResponse.urlKey_)  String url, @JsonKey(name: SignedUrlResponse.expiresInSecondsKey_)  int expiresInSeconds)?  $default,) {final _that = this;
switch (_that) {
case _SignedUrlResponse() when $default != null:
return $default(_that.url,_that.expiresInSeconds);case _:
  return null;
...
@jsonSerializable
class _SignedUrlResponse extends SignedUrlResponse {
  const _SignedUrlResponse({@JsonKey(name: SignedUrlResponse.urlKey_) required this.url, @JsonKey(name: SignedUrlResponse.expiresInSecondsKey_) required this.expiresInSeconds}): super._();
  factory _SignedUrlResponse.fromJson(Map<String, dynamic> json) => _$SignedUrlResponseFromJson(json);

/// url
@override@JsonKey(name: SignedUrlResponse.urlKey_) final  String url;
/// expiresInSeconds
@override@JsonKey(name: SignedUrlResponse.expiresInSecondsKey_) final  int expiresInSeconds;
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _SignedUrlResponse&&(identical(other.url, url) || other.url == url)&&(identical(other.expiresInSeconds, expiresInSeconds) || other.expiresInSeconds == expiresInSeconds));
}
