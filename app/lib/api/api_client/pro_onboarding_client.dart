library pro_onboarding_client;

import 'package:dio/dio.dart' hide Headers;
import 'package:retrofit/retrofit.dart';
import '../models/models.dart';
part 'pro_onboarding_client.g.dart';

@RestApi()
abstract class ProOnboardingClient {
  factory ProOnboardingClient(
    Dio dio, {
    ParseErrorLogger? errorLogger,
    String? baseUrl,
  }) = _ProOnboardingClient;
  ...
  startMyOnboardingV1ProOnboardingStartPost({
    @Body() required ProOnboardingStartRequest requestBody,
    @Header("Authorization") required String? authorization,
    @Header("X-User-Id") required String? xMinusUserMinusId,
    @CancelRequest() CancelToken? cancelToken,
    @SendProgress() ProgressCallback? onSendProgress,
  ...
  Future<HttpResponse<ProProfileView>> updateMyProProfileV1ProMeProfilePut({
    @Body() required ProProfileUpdateRequest requestBody,
    @Header("Authorization") required String? authorization,
    @Header("X-User-Id") required String? xMinusUserMinusId,
    @CancelRequest() CancelToken? cancelToken,
    @SendProgress() ProgressCallback? onSendProgress,
  ...
  Future<HttpResponse<ProPackageView>> createPackageV1ProMePackagesPost({
    @Body() required ProPackageCreateRequest requestBody,
    @Header("Authorization") required String? authorization,
    @Header("X-User-Id") required String? xMinusUserMinusId,
    @CancelRequest() CancelToken? cancelToken,
    @SendProgress() ProgressCallback? onSendProgress,
  ...
  @GET("/v1/pro/{pro_user_id}/packages")
  ...
  updatePackageV1ProMePackagesPackageIdPut({
    @Body() required ProPackageUpdateRequest requestBody,
    @Path("package_id") required String packageId,
    @Header("Authorization") required String? authorization,
    @Header("X-User-Id") required String? xMinusUserMinusId,
    @CancelRequest() CancelToken? cancelToken,
    @SendProgress() ProgressCallback? onSendProgress,
  ...
  @POST("/v1/pro/me/availability/rules")
  Future<HttpResponse<Map<String, dynamic>>>
  replaceAvailabilityRulesV1ProMeAvailabilityRulesPost({
    @Body() required ReplaceAvailabilityRulesRequest requestBody,
    @Header("Authorization") required String? authorization,
    @Header("X-User-Id") required String? xMinusUserMinusId,
    @CancelRequest() CancelToken? cancelToken,
    @SendProgress() ProgressCallback? onSendProgress,
  ...
  @POST("/v1/pro/me/availability/blackouts")
  Future<HttpResponse<BlackoutView>>
  createBlackoutV1ProMeAvailabilityBlackoutsPost({
    @Body() required BlackoutCreateRequest requestBody,
    @Header("Authorization") required String? authorization,
    @Header("X-User-Id") required String? xMinusUserMinusId,
    @CancelRequest() CancelToken? cancelToken,
    @SendProgress() ProgressCallback? onSendProgress,
  ...
  putMySelectedNichesV1ProNichesMinePut({
    @Body() required UpdateMyNichesRequest requestBody,
    @Header("Authorization") required String? authorization,
    @Header("X-User-Id") required String? xMinusUserMinusId,
    @CancelRequest() CancelToken? cancelToken,
    @SendProgress() ProgressCallback? onSendProgress,
  ...
  tagPortfolioMediaNichesV1ProMePortfolioMediaAssetIdNichesPost({
    @Body() required PortfolioNicheTagsRequest requestBody,
  ...
  @POST("/v1/pros/{pro_user_id}/booking-requests")
  Future<HttpResponse<BookingRequestView>>
  createBookingRequestV1ProsProUserIdBookingRequestsPost({
    @Body() required BookingRequestCreateRequest requestBody,
    @Path("pro_user_id") required String proUserId,
    @Header("Authorization") required String? authorization,
    @Header("X-User-Id") required String? xMinusUserMinusId,
    @CancelRequest() CancelToken? cancelToken,
  ...
  declineBookingRequestV1BookingRequestsRequestIdDeclinePost({
    @Body() required BookingDecisionRequest requestBody,
    @Path("request_id") required String requestId,
    @Header("Authorization") required String? authorization,
    @Header("X-User-Id") required String? xMinusUserMinusId,
    @CancelRequest() CancelToken? cancelToken,
