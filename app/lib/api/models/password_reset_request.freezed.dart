...
/// email
@JsonKey(name: PasswordResetRequest.emailKey_) String get email;
...
@useResult
$Res call({
@JsonKey(name: PasswordResetRequest.emailKey_) String email
});
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function(@JsonKey(name: PasswordResetRequest.emailKey_)  String email)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _PasswordResetRequest() when $default != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function(@JsonKey(name: PasswordResetRequest.emailKey_)  String email)  $default,) {final _that = this;
switch (_that) {
case _PasswordResetRequest():
return $default(_that.email);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function(@JsonKey(name: PasswordResetRequest.emailKey_)  String email)?  $default,) {final _that = this;
switch (_that) {
case _PasswordResetRequest() when $default != null:
return $default(_that.email);case _:
  return null;
...
class _PasswordResetRequest extends PasswordResetRequest {
  const _PasswordResetRequest({@JsonKey(name: PasswordResetRequest.emailKey_) required this.email}): super._();
  factory _PasswordResetRequest.fromJson(Map<String, dynamic> json) => _$PasswordResetRequestFromJson(json);

/// email
@override@JsonKey(name: PasswordResetRequest.emailKey_) final  String email;
