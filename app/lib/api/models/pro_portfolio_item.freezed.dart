...
@JsonKey(name: ProPortfolioItem.kindKey_) String get kind;/// thumbnailUrl
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,mediaAssetId,kind,thumbnailUrl,const DeepCollectionEquality().hash(nicheSlugs),isCover,createdAt);

@override
String toString() {
  return 'ProPortfolioItem(mediaAssetId: $mediaAssetId, kind: $kind, thumbnailUrl: $thumbnailUrl, nicheSlugs: $nicheSlugs, isCover: $isCover, createdAt: $createdAt)';
}
...
@useResult
$Res call({
@JsonKey(name: ProPortfolioItem.mediaAssetIdKey_) String mediaAssetId,@JsonKey(name: ProPortfolioItem.kindKey_) String kind,@JsonKey(name: ProPortfolioItem.thumbnailUrlKey_) String? thumbnailUrl,@JsonKey(name: ProPortfolioItem.nicheSlugsKey_) List<String>? nicheSlugs,@JsonKey(name: ProPortfolioItem.isCoverKey_) bool isCover,@JsonKey(name: ProPortfolioItem.createdAtKey_) DateTime createdAt
});
...
/// Create a copy of ProPortfolioItem
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? mediaAssetId = null,Object? kind = null,Object? thumbnailUrl = freezed,Object? nicheSlugs = freezed,Object? isCover = null,Object? createdAt = null,}) {
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function(@JsonKey(name: ProPortfolioItem.mediaAssetIdKey_)  String mediaAssetId, @JsonKey(name: ProPortfolioItem.kindKey_)  String kind, @JsonKey(name: ProPortfolioItem.thumbnailUrlKey_)  String? thumbnailUrl, @JsonKey(name: ProPortfolioItem.nicheSlugsKey_)  List<String>? nicheSlugs, @JsonKey(name: ProPortfolioItem.isCoverKey_)  bool isCover, @JsonKey(name: ProPortfolioItem.createdAtKey_)  DateTime createdAt)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _ProPortfolioItem() when $default != null:
return $default(_that.mediaAssetId,_that.kind,_that.thumbnailUrl,_that.nicheSlugs,_that.isCover,_that.createdAt);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function(@JsonKey(name: ProPortfolioItem.mediaAssetIdKey_)  String mediaAssetId, @JsonKey(name: ProPortfolioItem.kindKey_)  String kind, @JsonKey(name: ProPortfolioItem.thumbnailUrlKey_)  String? thumbnailUrl, @JsonKey(name: ProPortfolioItem.nicheSlugsKey_)  List<String>? nicheSlugs, @JsonKey(name: ProPortfolioItem.isCoverKey_)  bool isCover, @JsonKey(name: ProPortfolioItem.createdAtKey_)  DateTime createdAt)  $default,) {final _that = this;
switch (_that) {
case _ProPortfolioItem():
return $default(_that.mediaAssetId,_that.kind,_that.thumbnailUrl,_that.nicheSlugs,_that.isCover,_that.createdAt);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function(@JsonKey(name: ProPortfolioItem.mediaAssetIdKey_)  String mediaAssetId, @JsonKey(name: ProPortfolioItem.kindKey_)  String kind, @JsonKey(name: ProPortfolioItem.thumbnailUrlKey_)  String? thumbnailUrl, @JsonKey(name: ProPortfolioItem.nicheSlugsKey_)  List<String>? nicheSlugs, @JsonKey(name: ProPortfolioItem.isCoverKey_)  bool isCover, @JsonKey(name: ProPortfolioItem.createdAtKey_)  DateTime createdAt)?  $default,) {final _that = this;
switch (_that) {
case _ProPortfolioItem() when $default != null:
return $default(_that.mediaAssetId,_that.kind,_that.thumbnailUrl,_that.nicheSlugs,_that.isCover,_that.createdAt);case _:
  return null;
...
class _ProPortfolioItem extends ProPortfolioItem {
  const _ProPortfolioItem({@JsonKey(name: ProPortfolioItem.mediaAssetIdKey_) required this.mediaAssetId, @JsonKey(name: ProPortfolioItem.kindKey_) required this.kind, @JsonKey(name: ProPortfolioItem.thumbnailUrlKey_) this.thumbnailUrl, @JsonKey(name: ProPortfolioItem.nicheSlugsKey_) final  List<String>? nicheSlugs, @JsonKey(name: ProPortfolioItem.isCoverKey_) this.isCover = false, @JsonKey(name: ProPortfolioItem.createdAtKey_) required this.createdAt}): _nicheSlugs = nicheSlugs,super._();
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,mediaAssetId,kind,thumbnailUrl,const DeepCollectionEquality().hash(_nicheSlugs),isCover,createdAt);
...
/// Create a copy of ProPortfolioItem
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? mediaAssetId = null,Object? kind = null,Object? thumbnailUrl = freezed,Object? nicheSlugs = freezed,Object? isCover = null,Object? createdAt = null,}) {
