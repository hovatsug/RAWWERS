...
part of 'proof_galleries_client.dart';
...
class _ProofGalleriesClient implements ProofGalleriesClient {
  _ProofGalleriesClient(this._dio, {this.baseUrl, this.errorLogger});
  ...
  createProofGalleryV1GigsGigIdProofGalleryPost({
    required CreateProofGalleryRequest requestBody,
    ...
    final _options = _setStreamType<HttpResponse<ProofGalleryResponse>>(
      Options(method: 'POST', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
            '/v1/gigs/${gigId}/proof-gallery',
    ...
    late ProofGalleryResponse _value;
    try {
      _value = ProofGalleryResponse.fromJson(_result.data!);
    } on Object catch (e, s) {
  ...
  addGalleryItemsV1ProofGalleriesGalleryIdItemsPost({
    required AddGalleryItemsRequest requestBody,
    ...
    final _options = _setStreamType<HttpResponse<ProofGalleryResponse>>(
      Options(method: 'POST', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
            '/v1/proof-galleries/${galleryId}/items',
            queryParameters: queryParameters,
            data: _data,
            cancelToken: cancelToken,
            onSendProgress: onSendProgress,
  ...
  publishGalleryV1ProofGalleriesGalleryIdPublishPost({
    ...
    final _options = _setStreamType<HttpResponse<PublishGalleryResponse>>(
      Options(method: 'POST', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
            '/v1/proof-galleries/${galleryId}/publish',
            queryParameters: queryParameters,
            data: _data,
            cancelToken: cancelToken,
            onSendProgress: onSendProgress,
    ...
    final _result = await _dio.fetch<Map<String, dynamic>>(_options);
    late PublishGalleryResponse _value;
    try {
      _value = PublishGalleryResponse.fromJson(_result.data!);
    } on Object catch (e, s) {
      errorLogger?.logError(e, s, _options);
      rethrow;
    }
  ...
  getGalleryV1ProofGalleriesGalleryIdGet({
    ...
    _headers.removeWhere((k, v) => v == null);
    const Map<String, dynamic>? _data = null;
    final _options = _setStreamType<HttpResponse<GalleryDetailResponse>>(
      Options(method: 'GET', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
            '/v1/proof-galleries/${galleryId}',
            queryParameters: queryParameters,
            data: _data,
            cancelToken: cancelToken,
            onSendProgress: onSendProgress,
    ...
    final _result = await _dio.fetch<Map<String, dynamic>>(_options);
    late GalleryDetailResponse _value;
    try {
      _value = GalleryDetailResponse.fromJson(_result.data!);
    } on Object catch (e, s) {
      errorLogger?.logError(e, s, _options);
      rethrow;
    }
  ...
  saveSelectionV1ProofGalleriesGalleryIdSelectionsPost({
    required SaveSelectionRequest requestBody,
    required String galleryId,
    required String? authorization,
    required String? xMinusUserMinusId,
    CancelToken? cancelToken,
    ...
    final _data = <String, dynamic>{};
    _data.addAll(requestBody.toJson());
    final _options = _setStreamType<HttpResponse<SelectionResponse>>(
      Options(method: 'POST', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
            '/v1/proof-galleries/${galleryId}/selections',
            queryParameters: queryParameters,
            data: _data,
            cancelToken: cancelToken,
            onSendProgress: onSendProgress,
    ...
    final _result = await _dio.fetch<Map<String, dynamic>>(_options);
    late SelectionResponse _value;
    try {
      _value = SelectionResponse.fromJson(_result.data!);
    } on Object catch (e, s) {
      errorLogger?.logError(e, s, _options);
      rethrow;
    }
  ...
  submitSelectionV1ProofGalleriesGalleryIdSelectionsSubmitPost({
    ...
    _headers.removeWhere((k, v) => v == null);
    const Map<String, dynamic>? _data = null;
    final _options = _setStreamType<HttpResponse<SubmitSelectionResponse>>(
      Options(method: 'POST', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
            '/v1/proof-galleries/${galleryId}/selections/submit',
            queryParameters: queryParameters,
            data: _data,
            cancelToken: cancelToken,
            onSendProgress: onSendProgress,
    ...
    final _result = await _dio.fetch<Map<String, dynamic>>(_options);
    late SubmitSelectionResponse _value;
    try {
      _value = SubmitSelectionResponse.fromJson(_result.data!);
    } on Object catch (e, s) {
      errorLogger?.logError(e, s, _options);
      rethrow;
    }
  ...
  createUpsellIntentV1ProofGalleriesGalleryIdUpsellCreateIntentPost({
    required UpsellCreateIntentRequest? requestBody,
    required String galleryId,
    required String? authorization,
    required String? xMinusUserMinusId,
    CancelToken? cancelToken,
    ...
    final _options = _setStreamType<HttpResponse<UpsellCreateIntentResponse>>(
      Options(method: 'POST', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
            '/v1/proof-galleries/${galleryId}/upsell/create-intent',
            queryParameters: queryParameters,
            data: _data,
            cancelToken: cancelToken,
            onSendProgress: onSendProgress,
    ...
    final _result = await _dio.fetch<Map<String, dynamic>>(_options);
    late UpsellCreateIntentResponse _value;
    try {
      _value = UpsellCreateIntentResponse.fromJson(_result.data!);
    } on Object catch (e, s) {
      errorLogger?.logError(e, s, _options);
      rethrow;
    }
  ...
  getDownloadLinksV1ProofGalleriesGalleryIdDownloadsGet({
    ...
    _headers.removeWhere((k, v) => v == null);
    const Map<String, dynamic>? _data = null;
    final _options = _setStreamType<HttpResponse<DownloadsResponse>>(
      Options(method: 'GET', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
            '/v1/proof-galleries/${galleryId}/downloads',
            queryParameters: queryParameters,
            data: _data,
            cancelToken: cancelToken,
            onSendProgress: onSendProgress,
    ...
    final _result = await _dio.fetch<Map<String, dynamic>>(_options);
    late DownloadsResponse _value;
    try {
      _value = DownloadsResponse.fromJson(_result.data!);
    } on Object catch (e, s) {
      errorLogger?.logError(e, s, _options);
      rethrow;
    }
