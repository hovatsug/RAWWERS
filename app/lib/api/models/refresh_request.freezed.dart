...
/// refreshToken
@JsonKey(name: RefreshRequest.refreshTokenKey_) String get refreshToken;
...
@useResult
$Res call({
@JsonKey(name: RefreshRequest.refreshTokenKey_) String refreshToken
});
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function(@JsonKey(name: RefreshRequest.refreshTokenKey_)  String refreshToken)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _RefreshRequest() when $default != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function(@JsonKey(name: RefreshRequest.refreshTokenKey_)  String refreshToken)  $default,) {final _that = this;
switch (_that) {
case _RefreshRequest():
return $default(_that.refreshToken);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function(@JsonKey(name: RefreshRequest.refreshTokenKey_)  String refreshToken)?  $default,) {final _that = this;
switch (_that) {
case _RefreshRequest() when $default != null:
return $default(_that.refreshToken);case _:
  return null;
...
class _RefreshRequest extends RefreshRequest {
  const _RefreshRequest({@JsonKey(name: RefreshRequest.refreshTokenKey_) required this.refreshToken}): super._();
  factory _RefreshRequest.fromJson(Map<String, dynamic> json) => _$RefreshRequestFromJson(json);

/// refreshToken
@override@JsonKey(name: RefreshRequest.refreshTokenKey_) final  String refreshToken;
