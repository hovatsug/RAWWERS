...
part of 'media_rights_client.dart';
...
class _MediaRightsClient implements MediaRightsClient {
  _MediaRightsClient(this._dio, {this.baseUrl, this.errorLogger});
  ...
  Future<HttpResponse<GigMediaListResponse>> listGigMediaV1GigsGigIdMediaGet({
    ...
    final _options = _setStreamType<HttpResponse<GigMediaListResponse>>(
    ...
    late GigMediaListResponse _value;
    try {
      _value = GigMediaListResponse.fromJson(_result.data!);
    } on Object catch (e, s) {
  ...
  getMediaSignedUrlV1GigsGigIdMediaMediaAssetIdSignedUrlGet({
    ...
    required MediaDerivativeKind kind,
    ...
    final _options = _setStreamType<HttpResponse<SignedUrlResponse>>(
      Options(method: 'GET', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
            '/v1/gigs/${gigId}/media/${mediaAssetId}/signed-url',
            queryParameters: queryParameters,
            data: _data,
            cancelToken: cancelToken,
            onSendProgress: onSendProgress,
  ...
  downloadMediaV1GigsGigIdMediaMediaAssetIdDownloadGet({
    ...
    final _options = _setStreamType<HttpResponse<SignedUrlResponse>>(
      Options(method: 'GET', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
            '/v1/gigs/${gigId}/media/${mediaAssetId}/download',
            queryParameters: queryParameters,
            data: _data,
            cancelToken: cancelToken,
            onSendProgress: onSendProgress,
  ...
  createShareLinkV1GigsGigIdShareLinksPost({
    required ShareLinkCreateRequest requestBody,
    required String gigId,
    required String? authorization,
    required String? xMinusUserMinusId,
    CancelToken? cancelToken,
    ...
    final _options = _setStreamType<HttpResponse<ShareLinkCreateResponse>>(
      Options(method: 'POST', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
            '/v1/gigs/${gigId}/share-links',
            queryParameters: queryParameters,
            data: _data,
            cancelToken: cancelToken,
            onSendProgress: onSendProgress,
    ...
    final _result = await _dio.fetch<Map<String, dynamic>>(_options);
    late ShareLinkCreateResponse _value;
    try {
      _value = ShareLinkCreateResponse.fromJson(_result.data!);
    } on Object catch (e, s) {
      errorLogger?.logError(e, s, _options);
      rethrow;
    }
  ...
  Future<HttpResponse<ShareLinkViewResponse>> viewShareLinkV1ShareTokenGet({
    ...
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
    final _options = _setStreamType<HttpResponse<ShareLinkViewResponse>>(
      Options(method: 'GET', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
            '/v1/share/${token}',
    ...
    final _result = await _dio.fetch<Map<String, dynamic>>(_options);
    late ShareLinkViewResponse _value;
    try {
      _value = ShareLinkViewResponse.fromJson(_result.data!);
    } on Object catch (e, s) {
      errorLogger?.logError(e, s, _options);
      rethrow;
    }
  ...
  Future<HttpResponse<SharePingResponse>> pingShareLinkV1ShareTokenPingPost({
    required SharePingRequest requestBody,
    required String token,
    CancelToken? cancelToken,
    void Function(int, int)? onSendProgress,
    void Function(int, int)? onReceiveProgress,
    ...
    final _data = <String, dynamic>{};
    _data.addAll(requestBody.toJson());
    final _options = _setStreamType<HttpResponse<SharePingResponse>>(
      Options(method: 'POST', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
            '/v1/share/${token}/ping',
    ...
    final _result = await _dio.fetch<Map<String, dynamic>>(_options);
    late SharePingResponse _value;
    try {
      _value = SharePingResponse.fromJson(_result.data!);
    } on Object catch (e, s) {
      errorLogger?.logError(e, s, _options);
      rethrow;
    }
  ...
  Future<HttpResponse<GigConsentView>> getGigConsentV1GigsGigIdConsentGet({
    ...
    _headers.removeWhere((k, v) => v == null);
    const Map<String, dynamic>? _data = null;
    final _options = _setStreamType<HttpResponse<GigConsentView>>(
      Options(method: 'GET', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
            '/v1/gigs/${gigId}/consent',
            queryParameters: queryParameters,
            data: _data,
            cancelToken: cancelToken,
            onSendProgress: onSendProgress,
    ...
    final _result = await _dio.fetch<Map<String, dynamic>>(_options);
    late GigConsentView _value;
    try {
      _value = GigConsentView.fromJson(_result.data!);
    } on Object catch (e, s) {
      errorLogger?.logError(e, s, _options);
      rethrow;
    }
  ...
  Future<HttpResponse<GigConsentView>> putGigConsentV1GigsGigIdConsentPut({
    required UpdateGigConsentRequest requestBody,
    required String gigId,
    required String? authorization,
    required String? xMinusUserMinusId,
    CancelToken? cancelToken,
