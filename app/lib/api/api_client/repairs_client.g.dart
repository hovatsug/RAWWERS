...
class _RepairsClient implements RepairsClient {
  _RepairsClient(this._dio, {this.baseUrl, this.errorLogger});
  ...
  Future<HttpResponse<GearItemView>> createGearItemV1ProMeGearItemsPost({
    required GearItemCreateRequest requestBody,
    ...
    final _options = _setStreamType<HttpResponse<GearItemView>>(
      Options(method: 'POST', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
            '/v1/pro/me/gear-items',
    ...
    late GearItemView _value;
    try {
      _value = GearItemView.fromJson(_result.data!);
    } on Object catch (e, s) {
  ...
  Future<HttpResponse<List<GearItemView>>> listMyGearItemsV1ProMeGearItemsGet({
    ...
    final _options = _setStreamType<HttpResponse<List<GearItemView>>>(
    ...
    late List<GearItemView> _value;
    try {
      _value = _result.data!
          .map((dynamic i) => GearItemView.fromJson(i as Map<String, dynamic>))
          .toList();
    } on Object catch (e, s) {
      errorLogger?.logError(e, s, _options);
      rethrow;
  ...
  updateGearItemV1ProMeGearItemsGearItemIdPut({
    required GearItemUpdateRequest requestBody,
    ...
    final _options = _setStreamType<HttpResponse<GearItemView>>(
      Options(method: 'PUT', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
            '/v1/pro/me/gear-items/${gearItemId}',
            queryParameters: queryParameters,
            data: _data,
            cancelToken: cancelToken,
            onSendProgress: onSendProgress,
  ...
  @override
  Future<HttpResponse<dynamic>> deleteGearItemV1ProMeGearItemsGearItemIdDelete({
    required String gearItemId,
    required String? authorization,
    required String? xMinusUserMinusId,
    CancelToken? cancelToken,
