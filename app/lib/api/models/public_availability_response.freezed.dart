...
@JsonKey(name: PublicAvailabilityResponse.rulesKey_) List<AvailabilityRuleView> get rules;/// blackouts
...
@useResult
$Res call({
@JsonKey(name: PublicAvailabilityResponse.proUserIdKey_) String proUserId,@JsonKey(name: PublicAvailabilityResponse.rulesKey_) List<AvailabilityRuleView> rules,@JsonKey(name: PublicAvailabilityResponse.blackoutsKey_) List<BlackoutView> blackouts
});
...
as List<AvailabilityRuleView>,blackouts: null == blackouts ? _self.blackouts : blackouts // ignore: cast_nullable_to_non_nullable
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function(@JsonKey(name: PublicAvailabilityResponse.proUserIdKey_)  String proUserId, @JsonKey(name: PublicAvailabilityResponse.rulesKey_)  List<AvailabilityRuleView> rules, @JsonKey(name: PublicAvailabilityResponse.blackoutsKey_)  List<BlackoutView> blackouts)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _PublicAvailabilityResponse() when $default != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function(@JsonKey(name: PublicAvailabilityResponse.proUserIdKey_)  String proUserId, @JsonKey(name: PublicAvailabilityResponse.rulesKey_)  List<AvailabilityRuleView> rules, @JsonKey(name: PublicAvailabilityResponse.blackoutsKey_)  List<BlackoutView> blackouts)  $default,) {final _that = this;
switch (_that) {
case _PublicAvailabilityResponse():
return $default(_that.proUserId,_that.rules,_that.blackouts);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function(@JsonKey(name: PublicAvailabilityResponse.proUserIdKey_)  String proUserId, @JsonKey(name: PublicAvailabilityResponse.rulesKey_)  List<AvailabilityRuleView> rules, @JsonKey(name: PublicAvailabilityResponse.blackoutsKey_)  List<BlackoutView> blackouts)?  $default,) {final _that = this;
switch (_that) {
case _PublicAvailabilityResponse() when $default != null:
return $default(_that.proUserId,_that.rules,_that.blackouts);case _:
  return null;
...
class _PublicAvailabilityResponse extends PublicAvailabilityResponse {
  const _PublicAvailabilityResponse({@JsonKey(name: PublicAvailabilityResponse.proUserIdKey_) required this.proUserId, @JsonKey(name: PublicAvailabilityResponse.rulesKey_) required final  List<AvailabilityRuleView> rules, @JsonKey(name: PublicAvailabilityResponse.blackoutsKey_) required final  List<BlackoutView> blackouts}): _rules = rules,_blackouts = blackouts,super._();
...
/// rules
@override@JsonKey(name: PublicAvailabilityResponse.rulesKey_) List<AvailabilityRuleView> get rules {
...
as List<AvailabilityRuleView>,blackouts: null == blackouts ? _self._blackouts : blackouts // ignore: cast_nullable_to_non_nullable
as List<BlackoutView>,
  ));
}
