...
class _AuthClient implements AuthClient {
  ...
  Future<HttpResponse<TokenResponse>> loginV1AuthLoginPost({
    ...
    final _data = <String, dynamic>{};
    _data.addAll(requestBody.toJson());
    final _options = _setStreamType<HttpResponse<TokenResponse>>(
      Options(method: 'POST', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
            '/v1/auth/login',
  ...
  Future<HttpResponse<TokenResponse>> refreshV1AuthRefreshPost({
    required RefreshRequest requestBody,
    CancelToken? cancelToken,
    void Function(int, int)? onSendProgress,
    void Function(int, int)? onReceiveProgress,
    Map<String, dynamic>? extras = const {
  ...
  @override
  Future<HttpResponse<dynamic>> logoutV1AuthLogoutPost({
  ...
  @override
  Future<HttpResponse<dynamic>> verifyEmailRequestV1AuthVerifyEmailRequestPost({
    required VerifyEmailRequest requestBody,
    CancelToken? cancelToken,
    void Function(int, int)? onSendProgress,
    void Function(int, int)? onReceiveProgress,
    Map<String, dynamic>? extras = const {
  ...
  @override
  Future<HttpResponse<dynamic>> verifyEmailConfirmV1AuthVerifyEmailConfirmPost({
    required VerifyEmailConfirmRequest requestBody,
    CancelToken? cancelToken,
    void Function(int, int)? onSendProgress,
    void Function(int, int)? onReceiveProgress,
    Map<String, dynamic>? extras = const {
  ...
  passwordResetRequestV1AuthPasswordResetRequestPost({
    required PasswordResetRequest requestBody,
    CancelToken? cancelToken,
    void Function(int, int)? onSendProgress,
    void Function(int, int)? onReceiveProgress,
    Map<String, dynamic>? extras = const {
  ...
  @override
  Future<HttpResponse<dynamic>>
  passwordResetConfirmV1AuthPasswordResetConfirmPost({
    required PasswordResetConfirmRequest requestBody,
    CancelToken? cancelToken,
    void Function(int, int)? onSendProgress,
    void Function(int, int)? onReceiveProgress,
    Map<String, dynamic>? extras = const {
  ...
  Future<HttpResponse<MeResponse>> meV1MeGet({
    ...
    final _options = _setStreamType<HttpResponse<MeResponse>>(
  ...
  Future<HttpResponse<LocalePreferenceView>> meLocaleV1MeLocaleGet({
    ...
    _headers.removeWhere((k, v) => v == null);
    const Map<String, dynamic>? _data = null;
    final _options = _setStreamType<HttpResponse<LocalePreferenceView>>(
      Options(method: 'GET', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
            '/v1/me/locale',
    ...
    final _result = await _dio.fetch<Map<String, dynamic>>(_options);
    late LocalePreferenceView _value;
    try {
      _value = LocalePreferenceView.fromJson(_result.data!);
    } on Object catch (e, s) {
      errorLogger?.logError(e, s, _options);
      rethrow;
    }
  ...
  Future<HttpResponse<LocalePreferenceView>> updateMeLocaleV1MeLocalePut({
    required LocalePreferenceUpdateRequest requestBody,
    required String? authorization,
    required String? xMinusUserMinusId,
    CancelToken? cancelToken,
    void Function(int, int)? onSendProgress,
  ...
  Future<HttpResponse<UpgradeToProResponse>> upgradeToProV1MeUpgradeToProPost({
    ...
    _headers.removeWhere((k, v) => v == null);
    const Map<String, dynamic>? _data = null;
    final _options = _setStreamType<HttpResponse<UpgradeToProResponse>>(
      Options(method: 'POST', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
            '/v1/me/upgrade-to-pro',
            queryParameters: queryParameters,
            data: _data,
            cancelToken: cancelToken,
            onSendProgress: onSendProgress,
    ...
    final _result = await _dio.fetch<Map<String, dynamic>>(_options);
    late UpgradeToProResponse _value;
    try {
      _value = UpgradeToProResponse.fromJson(_result.data!);
    } on Object catch (e, s) {
      errorLogger?.logError(e, s, _options);
      rethrow;
    }
