...
/// loc
@JsonKey(name: ValidationError.locKey_) List<dynamic> get loc;/// msg
@JsonKey(name: ValidationError.msgKey_) String get msg;/// type
@JsonKey(name: ValidationError.typeKey_) String get type;
...
@useResult
$Res call({
@JsonKey(name: ValidationError.locKey_) List<dynamic> loc,@JsonKey(name: ValidationError.msgKey_) String msg,@JsonKey(name: ValidationError.typeKey_) String type
});
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function(@JsonKey(name: ValidationError.locKey_)  List<dynamic> loc, @JsonKey(name: ValidationError.msgKey_)  String msg, @JsonKey(name: ValidationError.typeKey_)  String type)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _ValidationError() when $default != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function(@JsonKey(name: ValidationError.locKey_)  List<dynamic> loc, @JsonKey(name: ValidationError.msgKey_)  String msg, @JsonKey(name: ValidationError.typeKey_)  String type)  $default,) {final _that = this;
switch (_that) {
case _ValidationError():
return $default(_that.loc,_that.msg,_that.type);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function(@JsonKey(name: ValidationError.locKey_)  List<dynamic> loc, @JsonKey(name: ValidationError.msgKey_)  String msg, @JsonKey(name: ValidationError.typeKey_)  String type)?  $default,) {final _that = this;
switch (_that) {
case _ValidationError() when $default != null:
return $default(_that.loc,_that.msg,_that.type);case _:
  return null;
...
class _ValidationError extends ValidationError {
  const _ValidationError({@JsonKey(name: ValidationError.locKey_) required final  List<dynamic> loc, @JsonKey(name: ValidationError.msgKey_) required this.msg, @JsonKey(name: ValidationError.typeKey_) required this.type}): _loc = loc,super._();
  factory _ValidationError.fromJson(Map<String, dynamic> json) => _$ValidationErrorFromJson(json);

/// loc
 final  List<dynamic> _loc;
/// loc
@override@JsonKey(name: ValidationError.locKey_) List<dynamic> get loc {
...
/// msg
@override@JsonKey(name: ValidationError.msgKey_) final  String msg;
/// type
@override@JsonKey(name: ValidationError.typeKey_) final  String type;
