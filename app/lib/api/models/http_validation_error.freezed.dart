...
/// detail
@JsonKey(name: HttpValidationError.detailKey_) List<ValidationError>? get detail;
...
@useResult
$Res call({
@JsonKey(name: HttpValidationError.detailKey_) List<ValidationError>? detail
});
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function(@JsonKey(name: HttpValidationError.detailKey_)  List<ValidationError>? detail)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _HttpValidationError() when $default != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function(@JsonKey(name: HttpValidationError.detailKey_)  List<ValidationError>? detail)  $default,) {final _that = this;
switch (_that) {
case _HttpValidationError():
return $default(_that.detail);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function(@JsonKey(name: HttpValidationError.detailKey_)  List<ValidationError>? detail)?  $default,) {final _that = this;
switch (_that) {
case _HttpValidationError() when $default != null:
return $default(_that.detail);case _:
  return null;
...
class _HttpValidationError extends HttpValidationError {
  const _HttpValidationError({@JsonKey(name: HttpValidationError.detailKey_) final  List<ValidationError>? detail}): _detail = detail,super._();
...
/// detail
@override@JsonKey(name: HttpValidationError.detailKey_) List<ValidationError>? get detail {
  final value = _detail;
