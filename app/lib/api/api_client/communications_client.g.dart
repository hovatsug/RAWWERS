...
part of 'communications_client.dart';
...
class _CommunicationsClient implements CommunicationsClient {
  _CommunicationsClient(this._dio, {this.baseUrl, this.errorLogger});
  ...
  Future<HttpResponse<UserContactView>> upsertMyContactV1MeContactPut({
    required UserContactUpdateRequest requestBody,
    ...
    final _options = _setStreamType<HttpResponse<UserContactView>>(
    ...
    late UserContactView _value;
    try {
      _value = UserContactView.fromJson(_result.data!);
    } on Object catch (e, s) {
  ...
  Future<HttpResponse<ConsentView>> setMyConsentV1MeConsentPost({
    required ConsentUpdateRequest requestBody,
    required String? authorization,
    required String? xMinusUserMinusId,
    CancelToken? cancelToken,
    void Function(int, int)? onSendProgress,
    ...
    final _data = <String, dynamic>{};
    _data.addAll(requestBody.toJson());
    final _options = _setStreamType<HttpResponse<ConsentView>>(
    ...
    final _result = await _dio.fetch<Map<String, dynamic>>(_options);
    late ConsentView _value;
    try {
      _value = ConsentView.fromJson(_result.data!);
    } on Object catch (e, s) {
      errorLogger?.logError(e, s, _options);
      rethrow;
    }
  ...
  Future<HttpResponse<CallSessionView>> requestOutboundCallV1CallsRequestPost({
    required CallRequestBody requestBody,
    required String? authorization,
    required String? xMinusUserMinusId,
    CancelToken? cancelToken,
    void Function(int, int)? onSendProgress,
    ...
    final _data = <String, dynamic>{};
    _data.addAll(requestBody.toJson());
    final _options = _setStreamType<HttpResponse<CallSessionView>>(
      Options(method: 'POST', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
            '/v1/calls/request',
    ...
    final _result = await _dio.fetch<Map<String, dynamic>>(_options);
    late CallSessionView _value;
    try {
      _value = CallSessionView.fromJson(_result.data!);
    } on Object catch (e, s) {
      errorLogger?.logError(e, s, _options);
      rethrow;
    }
  ...
  telephonyWebhookV1WebhooksTelephonyPost({
    ...
    queryParameters.removeWhere((k, v) => v == null);
    final _headers = <String, dynamic>{
      r'X-Telephony-Signature': xMinusTelephonyMinusSignature,
    };
    _headers.removeWhere((k, v) => v == null);
  ...
  summarizeCallV1CallsCallSessionIdAISummaryPost({
    ...
    _headers.removeWhere((k, v) => v == null);
    const Map<String, dynamic>? _data = null;
    final _options = _setStreamType<HttpResponse<CallSummaryResponse>>(
      Options(method: 'POST', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
            '/v1/calls/${callSessionId}/ai/summary',
            queryParameters: queryParameters,
            data: _data,
            cancelToken: cancelToken,
            onSendProgress: onSendProgress,
    ...
    final _result = await _dio.fetch<Map<String, dynamic>>(_options);
    late CallSummaryResponse _value;
    try {
      _value = CallSummaryResponse.fromJson(_result.data!);
    } on Object catch (e, s) {
      errorLogger?.logError(e, s, _options);
      rethrow;
    }
