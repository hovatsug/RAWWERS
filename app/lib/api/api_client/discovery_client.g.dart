...
class _DiscoveryClient implements DiscoveryClient {
  _DiscoveryClient(this._dio, {this.baseUrl, this.errorLogger});
  ...
  Future<HttpResponse<DiscoverProsResponse>> discoverProsV1DiscoverProsGet({
    ...
    final _options = _setStreamType<HttpResponse<DiscoverProsResponse>>(
    ...
    late DiscoverProsResponse _value;
    try {
      _value = DiscoverProsResponse.fromJson(_result.data!);
    } on Object catch (e, s) {
  ...
  getPublicProProfileV1ProsProUserIdPublicGet({
    ...
    _headers.removeWhere((k, v) => v == null);
    const Map<String, dynamic>? _data = null;
    final _options = _setStreamType<HttpResponse<ProPublicProfileResponse>>(
      Options(method: 'GET', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
            '/v1/pros/${proUserId}/public',
            queryParameters: queryParameters,
            data: _data,
            cancelToken: cancelToken,
            onSendProgress: onSendProgress,
    ...
    final _result = await _dio.fetch<Map<String, dynamic>>(_options);
    late ProPublicProfileResponse _value;
    try {
      _value = ProPublicProfileResponse.fromJson(_result.data!);
    } on Object catch (e, s) {
      errorLogger?.logError(e, s, _options);
      rethrow;
    }
  ...
  getNichePricingPreviewV1ProsProUserIdNichesNicheIdPricingPreviewGet({
    ...
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
    final _options = _setStreamType<HttpResponse<NichePricingPreviewResponse>>(
      Options(method: 'GET', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
            '/v1/pros/${proUserId}/niches/${nicheId}/pricing-preview',
            queryParameters: queryParameters,
            data: _data,
            cancelToken: cancelToken,
            onSendProgress: onSendProgress,
    ...
    final _result = await _dio.fetch<Map<String, dynamic>>(_options);
    late NichePricingPreviewResponse _value;
    try {
      _value = NichePricingPreviewResponse.fromJson(_result.data!);
    } on Object catch (e, s) {
      errorLogger?.logError(e, s, _options);
      rethrow;
    }
  ...
  Future<HttpResponse<MatchResponse>> discoverMatchV1DiscoverMatchPost({
    required MatchRequest requestBody,
    required String? authorization,
    required String? xMinusUserMinusId,
    CancelToken? cancelToken,
    void Function(int, int)? onSendProgress,
    ...
    final _options = _setStreamType<HttpResponse<MatchResponse>>(
  ...
  createAnalyticsEventV1AnalyticsPost({
    required AnalyticsCreateRequest requestBody,
    required String? authorization,
    required String? xMinusUserMinusId,
    CancelToken? cancelToken,
    void Function(int, int)? onSendProgress,
